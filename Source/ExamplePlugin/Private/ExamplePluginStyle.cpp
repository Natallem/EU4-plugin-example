...
void FExamplePluginStyle::Shutdown()
{
...
FName FExamplePluginStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("ExamplePluginStyle"));
	return StyleSetName;
}
...
void FExamplePluginStyle::ReloadTextures()
{
...
const ISlateStyle& FExamplePluginStyle::Get()
{
